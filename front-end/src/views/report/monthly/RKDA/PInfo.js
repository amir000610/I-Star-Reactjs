            ...
            <CCard className="mb-4">
              ...
              <CCardBody>
                ...
                <CTable className="mt-3" responsive bordered>
                  ...
                  <CTableBody>
                    {Xinstitutiondata?.map((val, key) => {
                      return (
                        <CTableRow key={key}>
                          <CTableDataCell color="dark">{key + 1}</CTableDataCell>
                          <CTableDataCell>
                            {val.learning_training_institutions}(Putera)
                          </CTableDataCell>
                          <CTableDataCell>
                            <center>
                              {
                          ...
                          <CTableDataCell>
                            <center>
                              {
                                StudentData?.filter(
                                  (idx) => idx.gender === 'MALE' && idx.institution_id === 8,
                                ).length
                              }
                            </center>
                          </CTableDataCell>
                    ...
                    {Xinstitutiondata?.map((val, key) => {
                      return (
                        <CTableRow key={key}>
                          <CTableDataCell color="dark">{key + 1}</CTableDataCell>
                          <CTableDataCell>
                            {val.learning_training_institutions}(Puteri)
                          </CTableDataCell>
                          <CTableDataCell>
                            <center>-</center>
                          </CTableDataCell>
                          ...
                          <CTableDataCell>
                            <center>
                              {
                                StudentData?.filter(
                                  (idx) => idx.gender === 'FEMALE' && idx.institution_id === 8,
                                ).length
                              }
                            </center>
                          </CTableDataCell>
...
export default ParticipantInfo2
